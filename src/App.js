    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button className="homeButtons__touchdown" onClick={() => setCountHome(valueHome + 7)}>Home Touchdown</button>

          <button className="homeButtons__fieldGoal" onClick={() => setCountHome(valueHome + 3)}>Home Field Goal</button>
        </div>
        <div className="awayButtons">
          <button className="awayButtons__touchdown" onClick={() => setCountAway(valueAway + 7)}>Away Touchdown</button>
